...
if ($onGae) {
    ...
    define('DB_NAME', 'wp_website_db_PROD');
    /** Production login info */
    define('DB_HOST', ':/cloudsql/quiteoften-wp-website:us-central1:quiteoften-wp-website-db');
    define('DB_USER', 'root');
    define('DB_PASSWORD', '6@NiD#SRq?o6@p');
} else {
    /** The name of the local database for WordPress */
    define('DB_NAME', 'wp_website_db_DEV');
    /** Local environment MySQL login info */
    define('DB_HOST', '35.226.168.183');
    define('DB_USER', 'root');
    define('DB_PASSWORD', '6@NiD#SRq?o6@p');
}
